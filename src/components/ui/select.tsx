...
export const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, options, placeholder, invalid, ...props }, ref) => (
    <select
      ...
      className={cn(
        "flex h-10 w-full appearance-none rounded-lg border bg-background/50 px-3 py-2 text-sm text-foreground " +
        ...
        // Error state: red border + red ring (overrides focus green)
        invalid
