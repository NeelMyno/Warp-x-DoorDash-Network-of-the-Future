    ...
    <div className="grid gap-3 lg:grid-cols-3">
      <div className="rounded-xl border border-border bg-background/10 p-4">
        ...
        <div className="mt-2 text-xs text-muted-foreground">
          Total: <span className="font-mono text-foreground/90">{formatCurrency(regularCost)}</span>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-background/10 p-4">
        ...
        <div className="mt-2 text-xs text-muted-foreground">
          Total: <span className="font-mono text-foreground/90">{formatCurrency(discountedCost)}</span>
        </div>
      </div>
