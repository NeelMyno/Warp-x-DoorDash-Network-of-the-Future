    ...
    <div className="rounded-xl border border-border bg-background/10 p-5">
      ...
      <div className="mt-4 flex items-center justify-between gap-4 rounded-lg border border-border/60 bg-background/5 px-4 py-3">
        <div className="text-center">
          <div className="text-[11px] text-muted-foreground">Total (regular)</div>
          <div className="mt-0.5 tabular-nums text-sm text-foreground/70">
        ...
        <div className="text-center">
          <div className="text-[11px] text-muted-foreground">Total (with density)</div>
        ...
        <div className="ml-2 rounded-lg border border-[var(--warp-success-strong)]/30 bg-[var(--warp-success-soft)] px-2.5 py-1.5 text-center">
          <div className="text-[11px] text-[var(--warp-success-strong)]">Savings</div>
          <div className="tabular-nums text-sm font-semibold text-[var(--warp-success-strong)]">
